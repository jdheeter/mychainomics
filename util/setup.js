  ...
  try {
    ...
    const result = await api.transact({
      actions: [
        ...
        // { account,authorization,name:"transfer",data:{from:contract,to:"chainomic",quantity:"2500000000.0000 EOS",memo:"lul"}},
        // { account,authorization,name:"create",data:{issuer:contract,maximum_supply:"250000000000.0000 chainomic"}},
        // { account,authorization,name:"issue",data:{to:contract,quantity:"250000000000.0000 chainomic",memo:"lul"}},
        // { account,authorization,name:"transfer",data:{from:contract,to:"john",quantity:"2500000000.0000 chainomic",memo:"lul"}},
        // { account,authorization,name:"transfer",data:{from:contract,to:"chainomic",quantity:"2500000000.0000 chainomic",memo:"lul"}},
